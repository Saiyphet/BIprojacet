                        ...
                        <div class="col-md-4">
                            <div class="single-report">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0"> ພະນັກງານ</h4>
                        ...
                        <div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class=" mb-0">ຫຍັງບໍ່ທັນຍືນຍັນ</h4>
                        ...
                        <div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class=" mb-0">ປະຕິເສດການຍືນຍັນ</h4>
                        ...
                        <div class="col-md-4">
                            <div class="single-report">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class=" mb-0">ໄດ້ຮັບການຍຶນຍັນແລ້ວ</h4>
							...
							<div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <select class="custome-select border-0 pr-3">
                                        ...
                                        <tr>
                                            ...
                                            if($stats==1){
                                             ?>
                                                 <span style="color: green">ຍີນຍັນ <i class="fa fa-check-square-o"></i></span>
                                                 <?php } if($stats==2)  { ?>
                                                <span style="color: red">ບໍ່ຮັບການຍີນຍັນ <i class="fa fa-times"></i></span>
                                                 <?php } if($stats==0)  { ?>
                                            <span style="color: blue">ກຳລັງຍີນຍັນ <i class="fa fa-spinner"></i></span>
                                            <?php } ?>
                                            ...
                                            <td><a href="employeeLeave-details.php?leaveid=<?php echo htmlentities($result->lid);?>" class="btn btn-secondary btn-sm">ກວດຂໍ້ມູນ</a></td>
                                            </tr>
                                                <?php $cnt++;} }?>
                                            </tbody>
                                                </table>
