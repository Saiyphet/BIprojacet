                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">ລາຍງານຂໍ້ມູນ</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="single-table">
                                    ...
                                    <tr>
                                             ...
                                             <td ><b>ວັນເດືອນປີ</b></td>
                                            <td colspan="1"><?php echo htmlentities($result->Fromdate);?></td>
                                            <td><b>ເວລາເລີ່ມສອນ</b></td>
                                            <td colspan="1"><?php echo htmlentities($result->timestart);?></td>
                                            <td><b>ຈົບເວລາສອນ</b></td>
                                            <td colspan="1"><?php echo htmlentities($result->endtime);?></td>
                                            
                                        </tr>
                                        <tr>
                                             
                                             <td ><b>ເບີຫ້ອງທີ່ໃຊ້ສອນ</b></td>
                                            <td colspan="1"><?php echo htmlentities($result->classroom);?></td>
                                            <td><b>ຫ້ອງສອນນັກສຶກສາ</b></td>
                                            <td colspan="1"><?php echo htmlentities($result->class);?></td>
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <div class="modal-body">
                                    ...
                                    <select class="custom-select" name="status" required="">
                                        ...
                                        <option value="1">ຍືນຍັນ </option>
                                        <option value="2">ບໍ່ຮັບການຍືນຍັນ</option>
                                    </select></p>
                                    <br>
                                    <p><textarea id="textarea1" name="description" class="form-control" name="description" placeholder="ໝາຍເຫດ" row="5" maxlength="500" required></textarea></p>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-danger" data-dismiss="modal">ອອກ</button>
                                    <button type="submit" class="btn btn-success" name="update">ຍືນຍັນ</button>
                                </div>
                                </div>
                            </div>
                            </div>
